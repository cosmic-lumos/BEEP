...
function MyPage(){
    ...
    return (
        <Container width="100vw" height="100vh" flexDirection="row" justifyContent="center">
            <Container width="20%" height="100vh" flexDirection="column" justifyContent="flex-start">
                <Header onClick={GoToMain}>BEEP!</Header>

            </Container>
            <Container width="60%" height="100%" flexDirection="column" justifyContent="center">
                <Container width="90%" height="90%" flexDirection="column" justifyContent="flex-start" bgColor="#EDEDED">
                    <Textdiv> 
                        <Title fontSize="45px" margin="0px 0px 20px 0px"> 이준석 님 안녕하세요! </Title>
                    </Textdiv>
                    <Textdiv> 
                        <Title fontSize="35px" margin="0px 0px 20px 0px"> 내가 빌린 항목 </Title>
                    </Textdiv>
